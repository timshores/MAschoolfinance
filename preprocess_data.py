...
# ----------------------------
matched_gdf["geometry"] = matched_gdf["geometry"].simplify(tolerance=0.001, preserve_topology=True)
...
# Optional: Comment out if not needed for deployment
